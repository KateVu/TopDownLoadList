package com.katevu.top10downloader
        ...
        when (item.itemId) {
            ...
            R.id.mnu10, R.id.mnu25 -> {
                if (!item.isChecked) {
                    ...
                    Log.d(TAG, "opOptionItemSelected: ${item.title} setting limit to $feedLimit")
                } else {
...
//                            e.printStackTrace()
//                            "downloadXML: Security exception: ${e.message}"
//                        }
...
//            }
            /**
             * read whole lot to stream -> not good for big file
             */
            private fun downloadXML (urlPath: String?): String {
